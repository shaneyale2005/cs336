...
def get_flashattention_autograd_function_pytorch() -> Type:
    ...
    from cs336_systems.flash_attn.flash_attn_pytorch import FlashAttentionPyTorchImpl
...
def get_flashattention_autograd_function_triton() -> Type:
    ...
    # raise NotImplementedError
    from cs336_systems.flash_attn.flash_attn_triton import FlashAttentionTritonImpl
...
def get_ddp_individual_parameters(module: torch.nn.Module) -> torch.nn.Module:
    ...
    # raise NotImplementedError
    from cs336_systems.parallel.ddp import DDPModel
...
def get_sharded_optimizer(params, optimizer_cls: Type[torch.optim.Optimizer], **kwargs) -> torch.optim.Optimizer:
    ...
    """
    # raise NotImplementedError
    from cs336_systems.parallel.optimizer import ShardedOptimizer
